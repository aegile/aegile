...
export default function ProjectsCard() {
  ...
  return (
    ...
    >
      ...
      <Separator />
      <CardFooter className="group gap-x-3 px-5 py-3 text-xs text-muted-foreground">
        <div className="flex items-center">
          <CheckCircledIcon className="mr-1 h-3 w-3" />
          <div className="group relative flex w-fit items-center justify-center">
            ...
            <p className="absolute opacity-0 transition-opacity duration-200 ease-in-out group-hover:opacity-100">
              {progressPerc}%
            </p>
          </div>
        </div>
